    ...
    <>
      ...
      <div className="p-5 lg:p-0 w-full mb-15">
        <section className="mb-16 flex flex-col gap-12 lg:mb-0 lg:min-h-fit">
          ...
          <div className="animate-slide-in-bottom w-full max-w-[1300px] mx-auto p-5 bg-linear-to-b from-stone-700/20 to-stone-900/50 border border-stone-700 rounded-4xl text-white unbounded">
            <div className="grid h-fit lg:h-[400px] lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-2">
              <div className="bg-linear-to-b from-stone-800/65 to-stone-800/75 rounded-3xl py-6 px-5">
              ...
              <div className="bg-linear-to-b from-stone-800/65 to-stone-800/75 rounded-3xl py-6 px-5 lg:col-span-2 h-[200px]">
              ...
              <div className="bg-linear-to-b from-stone-800/65 to-stone-800/75 rounded-3xl py-6 px-5 md:col-span-1 lg:col-span-1 h-[200px]">
