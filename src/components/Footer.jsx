  ...
  return (
    <>
        <footer className="px-5 lg:px-6 w-full mx-auto">
            <div data-aos="fade-up" className="w-full max-w-[1300px] bg-linear-to-b from-stone-400/5 to-stone-800/20 rounded-4xl p-4 mx-auto text-white mb-3">
                <div className="space-y-3">
                    <div className="bg-linear-to-b from-stone-800/30 to-stone-800/65 rounded-3xl p-4 flex flex-col items-start lg:w-[800px]">
            ...
            <div data-aos="fade-up" className="max-w-[1300px] w-full bg-linear-to-b from-stone-400/5 to-stone-800/20 rounded-4xl p-4 mx-auto mb-15">
                ...
                <form className="flex flex-col lg:flex-row items-center gap-2 justify-center mt-6 w-full lg:w-1/2 mx-auto">
                    <input
                        type="email"
                        placeholder="Email"
                        className="flex w-full lg:w-[200px] rounded-2xl px-4 py-3 text-white bg-stone-800/50 border border-stone-500 focus:outline-none focus:border-orange-400"
                    />
