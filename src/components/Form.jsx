  ...
  return (
    <>
      <div className="bg-stone-1000 m-auto flex min-h-screen  max-w-[1300px] flex-col items-center justify-center px-5 py-12 text-white md:flex-row lg:px-6">
        ...
        <div className="satoshireg w-full space-y-6 rounded-4xl bg-stone-900 p-8 md:w-1/2">
          <div>
          ...
          <button className="unbounded w-full rounded-xl bg-sky-400 px-6 py-3 font-medium text-black transition hover:bg-sky-300">
            Submit
          </button>
        </div>
      </div>
